...
<form  method="get">
  ...
  <input type="text" name="second" placeholder="Search by Year..">
...
<div class="container my-5">
  <table class="table">
    ...
    if(isset($_GET['submit'])){
      $search =$_GET['search'];
      $sql="Select * from books where authors='$search' or pubyear='$search'"; 
